...
@Component({
  selector: 'deepwater-performance-with-barcharts',
  templateUrl: './performance-with-barcharts.component.html',
  styleUrls: ['./performance-with-barcharts.component.scss']
})
export class PerformanceWithBarchartsComponent implements OnChanges {
